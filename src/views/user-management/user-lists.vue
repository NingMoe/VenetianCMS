<template>
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" element-loading-text="拼命加载中..." @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="sex" label="类型" min-width="100"  align="center">
			</el-table-column>
			<el-table-column prop="age" label="邀请码" min-width="130"  align="center">
			</el-table-column>
			<el-table-column prop="" label="手机号" min-width="130"  align="center">
			</el-table-column>
			<el-table-column prop="" label="上级关系" min-width="130"  align="center">
			</el-table-column>
            <el-table-column prop="" label="可用金额" min-width="150" sortable align="center">
			</el-table-column>
            <el-table-column prop="" label="账号状态" min-width="120"  align="center">
			</el-table-column>
            <el-table-column prop="lastloginTime" label="最后登录时间" width="200" sortable align="center">
			</el-table-column>
            <el-table-column prop="name" label="备注" min-width="130"  align="center">
			</el-table-column>
