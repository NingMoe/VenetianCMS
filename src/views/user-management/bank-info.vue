<template>
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" element-loading-text="拼命加载中..." @selection-change="selsChange" style="width: 100%;">
			<el-table-column prop="usename" label="用户名" min-width="120" sortable align="center">
			</el-table-column>
			<el-table-column prop="sex" label="银行名称" min-width="100" sortable align="center">
			</el-table-column>
			<el-table-column prop="age" label="银行账号" min-width="100" sortable align="center">
			</el-table-column>
			<el-table-column prop="birth" label="开户姓名" min-width="120" sortable align="center">
			</el-table-column>
			<el-table-column prop="addr" label="开户行" min-width="180" sortable align="center">
			</el-table-column>
